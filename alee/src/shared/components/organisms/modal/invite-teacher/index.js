			...
			<Modal.Content scrolling>
				<Modal.Description>
					<Grid>
						...
						<Grid.Column width={16}>
							<Header as="h5">Do you want to invite teacher?</Header>
							<Button className="secondaryBtn" onClick={() => setInvite(false)}>No</Button>
							<Button className="primaryBtn" onClick={inviteTeacher}>Yes</Button>
						</Grid.Column>
						<Grid.Column width={16}>
							{invite && <Form>
