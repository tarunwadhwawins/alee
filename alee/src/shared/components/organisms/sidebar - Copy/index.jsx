    ...
    return (
    	<div className="Sidebar">
			...
			{!localStorage.getItem("BookType")  && localStorage.getItem("Usertype") === "school" && 
				<Menu text vertical>
					<Menu.Item  as={Link} to="upload-excel"  name='UploadExcel' active={activeItem === 'UploadExcel'} onClick={this.handleItemClick}>
						<Image src={DashboardWhite} className="white"/>
						<Image src={DashboardBlue} className="blue"/>
						<span>Upload Excel</span>
					</Menu.Item>
					<Menu.Item  as={Link} to="school-manage-teachers"  name='school-manage-teacher' active={activeItem === 'school-manage-teacher'} onClick={this.handleItemClick}>
