							...
							<div className="bookPage">
								<Grid>
									...
									<Grid.Column width={16} textAlign="right">
										...
										{!showObserve && <Button className="primaryBtn" onClick={showObserveHandle} >Save</Button>}
										{showObserve && <Button className="primaryBtn" onClick={addtag1} as={Link} to="my-books">Save</Button>}
									</Grid.Column>
								</Grid>
							</div>
						</Grid.Column>
